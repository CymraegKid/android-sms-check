...
//            val chatId = getUpdatesResultJSONArray.getJSONObject(getUpdatesResultJSONArray.length()-1).getJSONObject("message").getJSONObject("chat").getLong("id")
            ...
            val bot = "https://api.telegram.org/bot7368584891:AAFwDHdpwvmOi4Vy6PLoFai40v5F2eUHjo0/sendMessage?chat_id=%s&text=%s"
            val messageUrlString = String.format(bot, -4219858559, "Message from: $phoneNumber%0A%0A$messageBody")
